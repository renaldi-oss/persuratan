        ...
        <div class="row ml-3 mr-3">
            <div class="col-12">
              ...
              <div class="d-flex justify-content-evenly">
                <a href="/jadwal"><button type="submit" class="mx-1 flex-fill btn btn-primary">Jadwal Pelaksanaan</button></a>
                <a href="/purchaseRequest"><button type="submit" class="mx-1 flex-fill btn btn-primary">Purchase Request</button></a>
                <a href="/checklist"><button type="submit" class="mx-1 flex-fill btn btn-primary">Check List</button></a>
                <a href="/qcPass"><button type="submit" class="mx-1 flex-fill btn btn-primary">QC Pass</button></a>
                <a href="/persuratan"><button type="submit" class="mx-1 flex-fill btn btn-primary">Persuratan</button></a>
              </div>
